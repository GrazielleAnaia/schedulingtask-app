...
public class TaskEventConsumerService {
    ...
    private final Logger logger = LoggerFactory.getLogger(TaskEventConsumerService.class);
    private final EmailService emailService;
    private final ProcessedEventRepository repository;

    public TaskEventConsumerService(EmailService emailService, ProcessedEventRepository repository) {
